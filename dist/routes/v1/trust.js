...
const FRAUD_TYPES = ["account_takeover", "scam", "payment_fraud", "identity_theft"];
...
export default async function (fastify) {
    ...
    fastify.post("/trust/report-fraud", {
        ...
        const result = await reportFraud(body.phoneNumber, clientId, body.type, body.severity, body.description || "");
        if (!result.success) {
