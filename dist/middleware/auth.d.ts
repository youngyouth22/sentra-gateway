 ...
 */
export declare function verifySupabaseToken(request: FastifyRequest, reply: FastifyReply): Promise<undefined>;
/**
 * Authenticates requests using Sentra API Keys (x-api-key header).
 * Used for all programmatic/B2B API access.
 */
export declare function verifySentraApiKey(request: FastifyRequest, reply: FastifyReply): Promise<undefined>;
